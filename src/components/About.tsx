    ...
    <div className="about-section section-container" id="about">
      <div className="about-grid about-me">
        ...
        <div className="about-left">
          <h2 className="title">I DON'T JUST WRITE CODE. I BUILD PRODUCTS.</h2>
        ...
        <div className="about-right">
          ...
          <div className="about-achievements">
            ...
            <div className="achievement-item">
              <h4>LEADERSHIP</h4>
              <p>President of E-Cell and Social Service Clubs, coordinating events for 500+ students and managing hackathons.</p>
            </div>
          </div>
        </div>
